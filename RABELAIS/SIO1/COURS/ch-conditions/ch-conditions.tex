...
\begin{center}
	...
	\begin{tabular}{|c|c|c|}
		\hline
		\mintinline{python}{and} & \ccell True                & \ccell False               \\
		\hline
	...
	\begin{tabular}{|c|c|c|}
		\hline
		\mintinline{python}{or} & \ccell True                & \ccell False              \\
		\hline
		\ccell True             & \mintinline{python}{False} & \mintinline{python}{True} \\
		\hline
		\ccell False            & \mintinline{python}{True}  & \mintinline{python}{True} \\
		\hline
	\end{tabular}
\end{center}
