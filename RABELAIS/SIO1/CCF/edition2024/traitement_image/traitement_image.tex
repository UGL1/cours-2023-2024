...
\begin{questionnum}
    Compléter sur votre copie le code de la fonction \mintinline{python}{binarise} qui
    \begin{itemize}
...
\begin{questionnum}
    Compléter sur votre copie le code de la fonction \mintinline{python}{cree_image_vide} qui
    \begin{itemize}
...
\begin{questionnum}
    Compléter sur votre copie le code de la fonction \mintinline{python}{miroir_vertical}.
    \begin{verbatim}    
