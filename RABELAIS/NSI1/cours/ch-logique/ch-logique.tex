...
\begin{figure}[H]
    \begin{center}
        ...
        \end{tabular}
        \hspace{3em}
        \raisebox{-2em}{\includegraphics[width=4cm]{ch-logique/img/non}}
...
\begin{figure}[H]
    \begin{center}
        ...
        \end{tabular}
        \hspace{3em}
        \raisebox{-2em}{\includegraphics[width=4cm]{ch-logique/img/et}}
    \end{center}
...
\begin{figure}[H]
    \begin{center}
        ...
        \raisebox{-2em}{\includegraphics[width=4cm]{ch-logique/img/ou}}
    \end{center}
