...
{
    \begin{tikzpicture}
        \draw[color=lightgray,step=.5cm] (0,0) grid (7,5);
    \end{tikzpicture}
...
{
    \begin{tikzpicture}
        \draw[color=lightgray,step=.5cm] (0,0) grid (7,7);
    \end{tikzpicture}
}{
...
\picleft{0.33}{img/fig1}{\question Parmi les trois instructions suivantes, entourer celle qui construit et stocke dans la variable abr l’arbre représenté ci-contre.}
